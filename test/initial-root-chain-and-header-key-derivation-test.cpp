...
int main(void) noexcept {
	...
	throw_on_invalid_buffer(alice_send_chain_key);
	throw_on_invalid_buffer(alice_receive_chain_key);
	throw_on_invalid_buffer(alice_send_header_key);
	throw_on_invalid_buffer(alice_receive_header_key);
	throw_on_invalid_buffer(alice_next_send_header_key);
	...
	throw_on_invalid_buffer(bob_send_chain_key);
	throw_on_invalid_buffer(bob_receive_chain_key);
	throw_on_invalid_buffer(bob_send_header_key);
	throw_on_invalid_buffer(bob_receive_header_key);
	throw_on_invalid_buffer(bob_next_send_header_key);
